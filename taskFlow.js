...
const sampleData = [
    ...
    { type: "TASK", text: "Buy a spiny helmet", note: "Equip it when you can, and Keep it on", points: 10, coords: { x: 6178.00, y: 2960.00 } },
    ...
    { type: "TASK", text: "Buy a knife from the charter ship", points: 10, coords: { x: 5187.50, y: 2231.50 } },
    ...
    { type: "TASK", text: "Buy steel axe, Ask Bob for quest", note: "Dont drop bronze yet", points: 10, coords: { x: 6586.50, y: 2160.50 } },
    { type: "TASK", text: "Smelt Bronze Bar", note: "Skip if you didn't get ores", points: 10, coords: { x: 6568.25, y: 2301.50 } },
    { type: "TASK", text: "Milk Cow", points: 10, coords: { x: 6403.00, y: 2509.75 } },
    { type: "TASK", text: "Kill Chicken with Fists, take raw chicken", points: 10, coords: { x: 6451.75, y: 2383.75 } },
    { type: "TASK", text: "Bury its bones", points: 10, coords: { x: 6451.75, y: 2383.75 } },
    { type: "TASK", text: "Find needle in haystack - takes about a 1 min if unlucky", note: "totally skippable", points: 30, coords: { x: 6311.75, y: 2459.50 } },
    { type: "INSTRUCTION", text: "Get an egg from chicken coup" },
    { type: "TASK", text: "Pick 3 onions at farm house on the way to wheat field, eat one of the onions", points: 10, coords: { x: 6179.50, y: 2371.00 } },
    ...
    { type: "TASK", text: "Start vampyre slayer (Morgan). Go upstairs, get garlic from the cupboard.", points: 10, coords: { x: 6185.32, y: 2357.50 } },
    { type: "TASK", text: "Use Helmet on Hat Stand In Morgan's house, pick up hat", points: 10, coords: { x: 6185.32, y: 2357.50 } },
    ...
    { type: "TASK", text: "Once LvL15 Fishing, Catch 1 Anchovy", points: 10, coords: { x: 6142.07, y: 2237.50 } },
    ...
    { type: "TASK", text: "Once LvL 15 WC/FM Chop and Burn 1 Oak Log", points: 10, coords: { x: 6195.82, y: 2281.25 } },
    ...
    { type: "TASK", text: "Get Haircut (Building North of Museum)", points: 10, coords: { x: 6657.25, y: 2939.25 } },
    ...
    { type: "TASK", text: "Cook a 1 Shrimp", points: 10, coords: { x: 6522.50, y: 2196.50 } },
    ...
    { type: "INSTRUCTION", text: "Claim Dragonfire Shield from Duke", coords: { x: 6513.00, y: 2203.50 } },
    { type: "TASK", text: "Kill a frog in swamp", points: 10, coords: { x: 6548.00, y: 2096.50 } },
    { type: "TASK", text: "Buy a candle from the dude next to swamp cave entrance", points: 30, coords: { x: 6397.00, y: 2078.50 } },
    ...
    { type: "TASK", text: "Talk to Luthus (1), 10 bananas in the crate", points: 10, coords: { x: 5709.50, y: 2014.50 } },
    ...
    { type: "TASK", text: "Pickpocket guard", note: "40 thiev", points: 30, coords: { x: 6521.50, y: 2703.50 } },
    ...
    { type: "TASK", text: "Kill a mugger", note: "Next to champions guild/aubry's rune shop", points: 10, coords: { x: 6592.00, y: 2722.00 } },
    ...
    { type: "TASK", text: "Cut a Sapphires to 27 crafting", points: 10 },
    { type: "TASK", text: "Cut Emeralds to 34 crafting", note: "Keep 1" },
